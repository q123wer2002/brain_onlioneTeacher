...
elseif($action=="edit"&&$Apower[group_list])
{
	...
	write_group_cache();
	jump("脩改成功","index.php?lfj=group&job=edit&gid=$gid");
}
...
elseif($action=="list"&&$Apower[group_list])
{
	...
	write_group_cache();
	jump("脩改成功","index.php?lfj=$lfj&job=list");
}
