...
/*
	var indexOfCurPhoto=0;
	function FillPhotoList()
	{
		var filename="http://search.caishow.com:8080/caixiu/smallpic/1101182454859.jpg";
		var cropwidth="160.0";
		var cropheight="120.0";
		var ratio="1.0";
		var zoom="100";
		var width="160";
		var height="120";
		photo=new Photo(filename,cropwidth,cropheight,ratio,zoom,width,height);
		photolist[photolist.length]=photo;
	}

	function setPhoto( photo)
	{
		cvimg.src = photo.filename;
		cvimg.width = photo.cropWidth;
		cvimg.height = photo.cropHeight;
//			setMsg(photo);
	}
	...
	{
		 FillPhotoList();
		 document.all.indexOfCurPhoto.value=indexOfCurPhoto;
		 currentPhoto=photolist[indexOfCurPhoto];
		 setPhoto(currentPhoto);
	}

	function apply()
	{
		box.levelVal.value=eval(box.level.value);
			box.submit();
	}
...
//			edtd.innerHTML = edtd.innerHTML.replace("Í¼Æ¬ÔØÈë<BR>ÕˆÉÔµÈ...", "");
