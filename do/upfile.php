...
if(!$lfjid){
	...
	die("<A HREF='$webdb[www_url]/do/login.php' target='_blank'  onclick='window.self.close();'>請先在前台登錄</A>");
}
?>
<html>
<head>
...
if($postfile){
	...
	echo "上传成功,<A HREF=?fn=$fn&dir=$dir&label=$_GET[label]&ISone=$_GET[ISone]&oldfile=$newfile>妳可以继续或重新上传</A>";
	$fn || $fn="upfile";
