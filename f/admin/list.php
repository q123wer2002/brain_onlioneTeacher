...
$linkdb=array(
			"全部"=>"$admin_path&job=list",
			"已审核"=>"$admin_path&job=list&type=yz&fid=$fid",
			"未审核"=>"$admin_path&job=list&type=unyz&fid=$fid",
			"迴收站"=>"$admin_path&job=list&type=del&fid=$fid",
			"推荐"=>"$admin_path&job=list&type=levels&fid=$fid",
			"添加講師"=>"/post.php?fid=1",
			);
