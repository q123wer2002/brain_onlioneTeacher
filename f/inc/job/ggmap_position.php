...
if(!$webdb[gg_map_api]||($webdb[gg_map_api]=='ABQIAAAAlNgPp05cAGeYiuhUaYZaQxT2hWcVQgqOjltVi_oi0-IXnv8sfRRB0xK-_hJ6X9fvCiWkheAw1gnL8Q'&&$webdb[www_url]!='http://life.net')){
	die('<a href="http://code.google.com/intl/zh-CN/apis/maps/signup.html" target="_blank">請先申請一個谷歌地图API密钥</a>');
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="center"><div id="cusMarkTip">請點擊下方的图標开始在地图上標注位置</div></td>
  </tr>
  <tr>
