...
if($job=="list"&&$Apower[moneylog]){
	...
	$headhtml = $uid?"<span class=\"FL\">用户积分消费記录</span><span class='FR'><a href='?lfj=$lfj&job=list'>所有用户記录</a></span>":"<span class=\"FL\">用户积分消费記录</span>";
	...
	$headhtml = "<span class=\"FL\">查看用户积分消费記录</span><span class='FR'><a href='?lfj=$lfj&job=list'>返迴列表</a></span>";
