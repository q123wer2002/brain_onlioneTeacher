...
//ie7 can not return the full path, so...
	...
	*/
	...
	{
		window.open('' + usrname,'','top=50,left=200,width=500,height=450,scrollbars=no,resizable=no,center=yes');
	}
...
//			alert(title+"\n\n已经放入您的收藏夹!");
	...
	*/
	...
	{
		window.open('', 'diybook', 'toolbar=no,width=370,height=270,resizable=no,scrollbars=no');
	}
