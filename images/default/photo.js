...
//s:a进,b退,c當前,d数组,e导航宽,f等待小,g前数,h大高,i索引,k最大,l预载,n首,o,等待大,p尾,r切换,tAT,u自动,w大宽,xA宽,z原始
//l:Loading图片
...
function B(t){//大图树连接
	...
	if(0!=this){//加载成功
		...
		e.innerHTML='图片加载失败，自动加载下一张 <a href="'+t.d[0]+'" target="_blank">點擊打开本图片</a>';
		t.b=e;
		t.e=1;
	}
	if(t==s.c)S();
