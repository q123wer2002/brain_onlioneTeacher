...
var js_bits 			='已有字节数';
var js_help				='特效 代碼 - 帮助信息點擊相应的代碼按钮即可获得相应的说明和提示';
var js_direct			='特效 代碼 - 直接插入點擊代碼按钮後不出现提示即直接插入相应代碼';
var js_remind			='特效 代碼 - 提示插入點擊代碼按钮後出现向导窗口帮助您完成代碼插入';
var js_size_help		='文字大小標記设置文字大小.可变范围 1 - 6. 1 为最小 6 为最大.用法:  ';
var js_size				='大小';
var js_font_help		='字体標記给文字设置字体.用法: ';
var js_font				='要设置字体的文字';
var js_word				='文字';
var js_color_help		='颜色標記设置文本颜色.  任何颜色名都可以被使用.用法: ';
var js_color			='选择的颜色是:  ';
var js_bold_help		='加粗標記使文本加粗.用法: [b]这是加粗的文字[/b]';
var js_bold				='文字将被变粗.';
var js_italic_help		='斜体標記使文本字体变为斜体.用法: [i]这是斜体字[/i]';
var js_italic			='文字将变斜体';
var js_quote_help		='引用標記引用一些文字.用法: [quote]引用内容[/quote]';
var js_quote			='被引用的文字';
var js_fly_help			='飞行標記使文字飞行.用法: [fly]文字为这样文字[/fly]';
var js_fly				='飞行文字';
var js_move_help		='移动標記使文字产生移动效果.用法: [move]要产生移动效果的文字[/move]';
var js_move				='要产生移动效果的文字';
var js_shadow_help		='阴影標記使文字产生阴影效果.用法: [SHADOW=宽度, 颜色, 边界]要产生阴影效果的文字[/SHADOW]';
var js_shadow			='要产生阴影效果的文字';
var js_glow_help		='光晕標記使文字产生光晕效果.用法: [GLOW=宽度, 颜色, 边界]要产生光晕效果的文字[/GLOW]';
var js_glow_size		='文字的长度、颜色和边界大小';
var js_glow				='要产生光晕效果的文字';
var js_align_help		='对齐標記使用这個標記, 可以使文本左对齐、居中、右对齐.用法: [align=center|left|right]要对齐的文本[/align]';
var js_align_type		='对齐样式输入 ’center’ 表示居中, ’left’ 表示左对齐, ’right’ 表示右对齐.';
var js_align_error		='错误!类型只能输入 ’center’ 、 ’left’ 或者 ’right’.';
var js_align			='要对齐的文本';
var js_rm				='RM音乐標記插入一個RM链接標記使用方法: [rm]http://www.mmcbbs.com/rm/php.rm[/rm]';
var js_img				='图片標記插入图片用法: [img]http://www.mmcbbs.com/image/php.gif[/img]';
var js_wmv				='wmv標記插入wmv用法: [wmv]http://www.mmcbbs.com/wmv/php.wmv[/wmv]';
var js_url_help			='url標記使用url標記,可以使输入的url地阯以超链接的形式在帖子中显示.使用方法: [url]url地阯[/url]';
var js_url_name			='URL 名称: 菁菁论坛(可以为空)';
var js_url				='URL 地阯';
var js_code_help		='代碼標記使用代碼標記,可以使妳的程序代碼里面的 html 等標志不会被破坏.使用方法: [code]这里是代碼文字[/code]';
var js_code				='输入代碼';
var js_list_help		='列表標記建造一個文字或则数字列表.USE: [list][*]item1[*]item2[*]item3[/list]';
var js_list_type		='列表类型输入 ’a’ 表示字母列表, ’1’ 表示数字列表, 留空表示普通列表.';
var js_list_error		='错误!类型只能输入 ’a’、’A’ 、 ’1’ 或者留空.';
var js_list				='列表项空白表示结束列表';
var js_underline_help	='下划線標記给文字加下划線.用法: [u]要加下划線的文字[/u]';
var js_underline		='下划線文字';
var js_flash			='Flash 动画插入 Flash 动画.用法: [flash=宽度,高度]Flash 文件的地阯[/flash]';
var js_height			='宽度,高度';
var js_js_replace		='';
var js_search			='請输入搜寻目標关键字';
...
function setswf() {
 	if (helpmode){
		alert('Flash 动画\n插入 Flash 动画.\n用法: [flash=宽度,高度]Flash 文件的地阯[/flash]');
	} else if (nomode || document.selection && document.selection.type == "Text") {
