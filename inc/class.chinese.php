...
class Chinese
{
	 ...
	 *
	 * 详细说明
	 * @形参      字符串 $SourceLang 为需要转换的字符串的原编碼
	 *            字符串 $TargetLang 为转换的目標编碼
	 *            字符串 $SourceText 为等待转换的字符串
	 *            字符串 $CodetableDir 编碼对应表的目录
	 *
	 * @起始      1.0
	 * @最後修改  1.2
	 * @访问      公开
...
//		ereg(href="css/dir.css"
	...
	/**
	 * 将简体、繁体中文的 UNICODE 编碼转换为 UTF8 字符
	 *
	 * 详细说明
	 * @形参      数字 $c 简体中文汉字的UNICODE编碼的10进制
	 * @起始      1.1
	 * @最後修改  1.2
	 * @访问      内部
	 * @返迴      字符串
