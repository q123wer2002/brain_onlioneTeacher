...
$db_code['pic']='1';		// 寫1显示图片,寫0不显示
$db_code['flash']='1';		// 寫1显示flash,寫0不显示
$db_code['mpeg']='1';		// 寫1显示音乐影片,寫0不显示
$db_code['iframe']='1';		// 寫1显示框架,寫0不显示
...
function format_attachment($url,$d_id='',$name='',$size='',$hits='',$time=''){
		...
		
	{
		...
		$show="		<br>
				   ...
				   <td width=50%><font color=#FF0000>上传時間:</font>$time</td>
				   </tr>
				   <tr bgcolor=#FBFDFF> 
